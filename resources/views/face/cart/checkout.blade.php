    ...
    <div class="container">
        <div class="breadcrumb-content text-center">
            <ul>
                ...
                <li class="active"> پرداخت نهایی </li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="billing-info-wrap mr-50">
                        ...
                        <div class="row">
                            <p>در اینجا آدرس ارسال خود را انتخاب یا آدرس جدیدی را وارد کنید</p>
                            <div class="col-lg-6 col-md-6">
                                <div class="billing-info tax-select mb-20">
                                    <label> انتخاب آدرس تحویل سفارش <abbr class="required" title="required">*</abbr></label>
                                    <select id="address-select" class="email s-email s-wid" name="title">
                ...
                <div class="col-lg-5">
                    <form action="{{route('face.payment')}}" method="POST">
                        @csrf
